...
![Gameimage](https://raw.githubusercontent.com/albergv/godot_2dgame/master/img/gameimage.png "gameimage")

Los archivos para jugar al juego están en la carpeta "exec", catalogados por sistema operativo. Solo hay que descargar y ejecutar.
Por el momento solo está disponible para Windows y Linux.
Para más información visitar este enlace:
[Post videojuego Godot español](https://albergv.github.io/2025/11/08/godot-game/)
